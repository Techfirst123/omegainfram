...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    href: '/csr',
    description: 'Designing low-carbon infrastructure while empowering communities through energy access, skilling, and health initiatives.',
    statValue: '120+',
    statLabel: 'CSR Partners',
    children: [
      { label: 'Mission', href: '/#sustainability' },
      { label: 'Climate Impact', href: '/#sustainability' },
      { label: 'Responsible Delivery', href: '/#sustainability' },
